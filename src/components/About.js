    ...
    <article className="about active bg-eerie-black-2 border border-jet rounded-2xl p-4 shadow-shadow-1">
      ...
      <section className="about-text mb-10">
        ...
        <p className="text-light-gray text-2xl font-light leading-relaxed ">
          - [ 성실함 ] : 2년 반 동안 주 7일 동안 꾸준히 카페를 운영하며, 어려운
          상황에서도 포기하지 않고 지속적으로 노력했습니다. <br />- [ 프로그래밍
          프로젝트 경험 ] : 다양한 개발 프로젝트를 통해 기술 역량을 쌓았습니다.
          이클립스를 사용한 기프티콘 거래 플랫폼, 스프링부트와 React를 기반으로
          한 캠핑장 추천 모바일 플랫폼 등 다양한 프로젝트과 websokt과 webRTC를
          이용한 화상 술게임 플랫폼을 만들었습니다. <br />- [ 새로운 기술 학습 ]
          : 처음 해보는 자영업과 그에 따로으는 마케팅를 하면서 막히는 부분을
          새로운 배우걸 따로 부업으로 만들어서 새로운 소득을 만들만큼 새로운
          기술을 배고 학습하는걸 좋아합니다. <br />- [ 소통과 팀워크 ] : 직원과
          손님을 통해서 사람들과의 소통에 능숙합니다. <br />- [ 문제 해결 능력 ]
          : 프로젝트 진행하면 생기면서 겪은 어려움을 서치를 통해 해결하고
          유튜브를 통해 필요한 기술을 배우고, 직접 커피머신, 전기온수기 설치 및
          셀프 인테리어를 해결하는 등 자가 해결 능력을 발휘했습니다.
        </p>
      </section>
